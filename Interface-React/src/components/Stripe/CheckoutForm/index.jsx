    ...
    const handleSubmit = async (e) => {
        ...
        if (error) {
            ...
            try {
                ...
                toast.error('Falha no servidor. Por favor, tente novamente mais tarde.');
            }
        } else {
            navigate(
    ...
    return (
        <div className="container">
            <form id="payment-form" onSubmit={handleSubmit}>
                ...
                <button disabled={isLoading || !stripe || !elements} id="submit" className="submit-button">
                    <span id="button-text">
            ...
            <div className="mensagem">
                <p>Os métodos de pagamento podem variar de acordo com a sua região.</p>
            </div>
        </div>
    );
}