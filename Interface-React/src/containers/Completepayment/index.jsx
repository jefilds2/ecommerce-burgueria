...
const STATUS_CONTENT_MAP = {
    ...
    processing: {
        text: "Pagamento processando. Por favor, aguarde.",
        iconColor: "#6D6E78",
        icon: InfoIcon,
        buttonText: "Voltar para a loja",
        url: "/",
    ...
    requires_payment_method: {
        text: "Pagamento falhou. Por favor, tente novamente.",
        iconColor: "#DF1B41",
        icon: ErrorIcon,
    ...
    return (
        <div className="container">
            <div id="payment-status">
                ...
                <h2 className="payment-title" id="status-text">{STATUS_CONTENT_MAP[status].text}</h2>
